(function (scope) {
  ...
  var $elm$project_metadata_utils$Elm$Error$BadModule = F3(function (
    path,
    name,
    problems
  ) {
  ...
  var $elm$project_metadata_utils$Elm$Error$Problem = F3(function (
    title,
    region,
    message
  ) {
  ...
  var $elm$project_metadata_utils$Elm$Error$Style = F3(function (
    bold,
    underline,
    color
  ) {
  ...
  var $elm$project_metadata_utils$Elm$Error$Styled = F2(function (a, b) {
    return { $: 1, a: a, b: b };
  });
  ...
  var $elm$project_metadata_utils$Elm$Error$colorDecoder = A2(
    $elm$json$Json$Decode$andThen,
    $elm$project_metadata_utils$Elm$Error$toColor,
  ...
  var $elm$project_metadata_utils$Elm$Error$chunkDecoder = $elm$json$Json$Decode$oneOf(
    _List_fromArray([
      A2(
        ...
        $elm$project_metadata_utils$Elm$Error$Unstyled,
        $elm$json$Json$Decode$string
      ),
      A3(
        $elm$json$Json$Decode$map2,
        ...
        A4(
          ...
          A2(
            ...
            $elm$json$Json$Decode$nullable(
              $elm$project_metadata_utils$Elm$Error$colorDecoder
            )
          )
        ),
  ...
  var $elm$project_metadata_utils$Elm$Error$Region = F2(function (start, end) {
    return { aX: end, a9: start };
  });
  var $elm$project_metadata_utils$Elm$Error$Position = F2(function (
    line,
    column
  ) {
  ...
  var $elm$project_metadata_utils$Elm$Error$regionDecoder = A3(
    ...
    A2(
      $elm$json$Json$Decode$field,
      'start',
      $elm$project_metadata_utils$Elm$Error$positionDecoder
    ),
    A2(
      $elm$json$Json$Decode$field,
      'end',
  ...
  var $elm$project_metadata_utils$Elm$Error$problemDecoder = A4(
    ...
    A2(
      $elm$json$Json$Decode$field,
      'region',
      $elm$project_metadata_utils$Elm$Error$regionDecoder
    ),
    A2(
      $elm$json$Json$Decode$field,
      'message',
      $elm$json$Json$Decode$list(
        $elm$project_metadata_utils$Elm$Error$chunkDecoder
      )
    )
  );
  var $elm$project_metadata_utils$Elm$Error$badModuleDecoder = A4(
    ...
    A2(
      ...
      'problems',
      $elm$json$Json$Decode$list(
        $elm$project_metadata_utils$Elm$Error$problemDecoder
      )
    )
  );
      ...
      case 'compile-errors':
        return A2(
          ...
          A2(
            ...
            'errors',
            $elm$json$Json$Decode$list(
              $elm$project_metadata_utils$Elm$Error$badModuleDecoder
            )
          )
        );
      default:
        ...
        _List_fromArray([
          _Utils_Tuple2(
            ...
            (function ($) {
              return $elm$json$Json$Encode$object(
                _List_fromArray([
                  _Utils_Tuple2('column', $elm$json$Json$Encode$int($.U)),
                  _Utils_Tuple2('line', $elm$json$Json$Encode$int($.al)),
                ])
              );
            })($.aX)
          ),
  ...
  var $author$project$Errors$viewHeader = F2(function (title, maybeRegion) {
    if (maybeRegion.$ === 1) {
      return A2(
        $elm$html$Html$span,
        _List_fromArray([
      ...
      return A2(
        ...
        _List_fromArray([
          ...
          A2(
            ...
            _List_fromArray([$elm$html$Html$text('Jump To Problem')])
          ),
          $elm$html$Html$text('\n\n'),
        ])
      );
  ...
  var $author$project$Errors$addBold = F2(function (bool, attrs) {
    return bool
      ? A2(
          $elm$core$List$cons,
  ...
  var $author$project$Errors$addColor = F2(function (maybeColor, attrs) {
    if (maybeColor.$ === 1) {
      return attrs;
    } else {
  ...
  var $author$project$Errors$addUnderline = F2(function (bool, attrs) {
    return bool
      ? A2(
          $elm$core$List$cons,
  ...
  var $author$project$Errors$viewSeparator = F2(function (before, after) {
    return A2(
      $elm$html$Html$span,
      _List_fromArray([
      ...
      _List_fromArray([
        $elm$html$Html$text(
          A3($elm$core$String$padLeft, 80, ' ', before + '  â†‘    ') +
            ('\n' +
              ('====o======================================================================o====\n' +
                ('    â†“  ' + (after + '\n\n\n'))))
        ),
    ...
    return {
      aR: (function () {
        if (result.$ === 1) {
          var err = result.a;
          return _List_fromArray([
            $elm$html$Html$text($elm$json$Json$Decode$errorToString(err)),
          ]);
        } else {
          var error = result.a;
          return _List_fromArray([$author$project$Errors$viewError(error)]);
        }
      })(),
      O: 'Problem!',
    };
  ...
  var $author$project$Errors$main = $elm$browser$Browser$document({
    a$: function (flags) {
      return _Utils_Tuple2(
        A2(
          ...
          $elm$project_metadata_utils$Elm$Error$decoder,
          flags
        ),
    ...
    bc: F2(function (region, result) {
      return _Utils_Tuple2(result, $author$project$Errors$jumpTo(region));
    }),
    bd: $author$project$Errors$view,
  });
  _Platform_export({
    Errors: {
      init: $author$project$Errors$main($elm$json$Json$Decode$value)(0),
    },
  });
})(this);
